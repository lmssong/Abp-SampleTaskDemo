...
using SamleTaskDemo.Sessions;
using SamleTaskDemo.Web.Controllers.Results;
using SamleTaskDemo.Web.Models;
using SamleTaskDemo.Web.Models.Account;
...
{
    public class AccountController : SamleTaskDemoControllerBase
    {
